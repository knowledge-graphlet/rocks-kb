...
@Disabled
class ImportProtobufTaskTest {
    private static final Logger LOG = LoggerFactory.getLogger(ImportProtobufTaskTest.class);
    ...
    //File importFile = new File("/Users/kec/Solor/SOLOR-GUDID-20250827-reasoned-pb.zip");
